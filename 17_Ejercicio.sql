--Ejercicio 17 ¿Cuánto dinero hemos dejado de ingresar por el cupón "ULTIMO_SUSPIRO"? (Calcula la diferencia entre lo que hubiera sido sin descuento y lo que fue con descuento).
...
-- Hemos dejado de ingresar aproximadamente 359385 por el cupón "ULTIMO_SUSPIRO".
